...
# LS ANSWER:
# Spot will find himself in the "dog house" for this one. The family's 
# data is in shambles now.

# Why? In Python, dictionaries are mutable, and when passed to a function, 
# a reference to the dictionary is passed, not a copy. Thus, Spot's 
...
# The key aspect here is that the nested dictionaries (the individual 
# family members' data) are the ones being mutated. Each family member's 
# dictionary ({"age": x, "gender": y}) is accessed and modified. Since 
# these nested dictionaries are part of the larger munsters dictionary, 
...
# demo_dict; it just uses it, as-is. Thus, the object that gets changed by 
