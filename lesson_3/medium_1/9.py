...
# In bar, the parameter param is now "yes". The expression param == "no" and 
# foo() or "no" is evaluated as follows:

# param == "no" evaluates to False since param is "yes".
# Due to the and operator, foo() is not executed because the first part of 
# the and expression is already False.
